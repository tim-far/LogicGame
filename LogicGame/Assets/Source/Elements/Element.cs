...
{
    // Unity
    public GameObject texture;                  // Element texture, this variable is set in the Unity Editor
    ...
    public Vector3Int connectedTo;              // List of elements the output from the current element is connected to
